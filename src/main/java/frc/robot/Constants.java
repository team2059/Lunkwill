...
public final class Constants {
    ...
    public static final class Swerve {
        ...
        public static final double trackWidth = Units.inchesToMeters(19.5); // should be 19.5
        public static final double wheelBase = Units.inchesToMeters(16.5); // should be 16.5
