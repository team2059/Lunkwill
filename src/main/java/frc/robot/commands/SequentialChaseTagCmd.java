...
public class SequentialChaseTagCmd extends SequentialCommandGroup {
    ...
    public Command getCommand() {
        ...
        if (result.hasTargets() == false) {
            ...
            Translation2d A_rf = new Translation2d(Swerve.originToFront, Swerve.originToSide);
            ...
            Translation2d Originl0_rO = new Translation2d(Swerve.xCameraOffset, Swerve.yCameraOffset);
            ...
            Pose2d endingPose = new Pose2d(finalTranslation.getX(), finalTranslation.getY(),
                    new Rotation2d(yawTheta - Math.PI));
