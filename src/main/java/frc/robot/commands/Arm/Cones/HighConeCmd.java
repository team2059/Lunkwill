...
public class HighConeCmd extends SequentialCommandGroup {

  /** Creates a new MidCubeCmd. */
  public HighConeCmd(TiltArm tiltArm, ExtendArm extendArm, Pneumatics pneumatics) {
    ...
    addCommands(new PIDTiltArmCmd(tiltArm, Constants.Presets.UPPER_CONE_ARM_TILT),
        ...
        new PIDTiltArmCmd(tiltArm, Constants.Presets.UPPER_CONE_ARM_TILT-0.05),
