...
public class MidConeCmd extends SequentialCommandGroup {

  /** Creates a new MidCubeCmd. */
  public MidConeCmd(TiltArm tiltArm, ExtendArm extendArm, Pneumatics pneumatics) {
    ...
    addCommands(new PIDTiltArmCmd(tiltArm, Constants.Presets.MID_CONE_ARM_TILT),
        ...
        new PIDTiltArmCmd(tiltArm, Constants.Presets.MID_CONE_ARM_TILT - 0.05),
