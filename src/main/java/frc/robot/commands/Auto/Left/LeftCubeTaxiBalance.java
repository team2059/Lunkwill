...
public class LeftCubeTaxiBalance extends SequentialCommandGroup {
  /** Creates a new CenterConeTaxiAndBalanceCmd. */
  public LeftCubeTaxiBalance(SwerveBase swerveBase, TiltArm tiltArm, ExtendArm extendArm,
      Pneumatics pneumatics) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new HighCubeCmd(tiltArm, extendArm, pneumatics), swerveBase.followPathCmd("LeftCubeTaxiBalance"),
